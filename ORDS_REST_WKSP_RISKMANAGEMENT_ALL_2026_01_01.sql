...
-- Schema: WKSP_RISKMANAGEMENT  Date: Thu Jan 01 04:46:16 2026 
--
...
BEGIN
  ORDS.ENABLE_SCHEMA(
      ...
      p_url_mapping_pattern => 'risk_management',
...
exception
 ...
 when others then 
  ...
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.WKSP_RISKMANAGEMENT');
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.any.WKSP_RISKMANAGEMENT');
  l_roles(1) := 'oracle.dbtools.autorest.any.schema';
  l_roles(2) := 'oracle.dbtools.role.autorest.WKSP_RISKMANAGEMENT';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'oracle.dbtools.autorest.privilege.WKSP_RISKMANAGEMENT',
      p_roles          => l_roles,
      p_patterns       => l_patterns,
      p_modules        => l_modules,
      p_label          => 'WKSP_RISKMANAGEMENT metadata-catalog access',
      p_description    => 'Provides access to the metadata catalog of the objects in the WKSP_RISKMANAGEMENT schema.',
      p_comments       => NULL); 
